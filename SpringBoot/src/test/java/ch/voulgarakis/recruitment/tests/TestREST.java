...
import ch.voulgarakis.icsc2018.recruitment.controller.RecruitmentController;
 ...
 * EXC 5:
 * 
 * Have a look at the implementation of {@link RecruitmentController}. As you
 * can see, the implementation of the URL endpoint:
 * 
 * PUT /recruitment/apply?applicantName=Claus&vacancyName=Santa
 * 
 * is missing. As you can see, this endpoint should accept as URL parameters the
 * applicantName and vacancyName, then proceed with the invocation of the
 * apply() method from the ServiceLayer ({@link RecruitmentServiceImpl}).
 * 
 * Edit the controller accordingly, by implementing the fore-mentioned endpoint.
 * Doing so should allow correctly passing this test.
 */
